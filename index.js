...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction reaching up to its parent function for the value of internal is an example of closure.  nestedFunction itself does not have the const internal within it, but closure allows it to reach outside itself to its parent function to use that variable
...
function summation(number) {
  ...
  return numArray.reduce((accumulator, item) => {
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    let lowerNames = data.map(function(item) {
  ...
  */
  ...
  function lowPopulationAnimals(data){
    let lowPops = data.filter(item => item.population<5);
    return lowPops;
  }
...
// 🦄 💪 Stretch Task: Extend the base class CuboidMaker with a sub class called CubeMaker.  Find out the formulas for volume and surface area for cubes and create those methods using the dimension properties from CuboidMaker.  Test your work by logging out your volume and surface area. 🦄 💪
  ...
  //   }
  //   cubeVolume(){
  //     return cubeAttrs.length*cubeAttrs.width*cubeAttrs.height;
  //   }
  //   cubeSurfaceArea(){
  //     return 6*(cubeAttrs.length+cubeAttrs.width+cubeAttrs.height);
  //   }
  // }
